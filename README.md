...
Вы можете создать сколько угодно календарей. Однако для того, чтобы правильно с ними обращаться, установите разные, `calendar_id` sесли вы хотите их различать.
